...
export const ModelSelectorContent = ({
  ...
  <PopoverContent
    align="start"
    className={cn(
      "w-[320px] p-0 rounded-xl border border-border/60 bg-black backdrop-blur-xl shadow-[var(--shadow-float)]",
      className
    )}
    side="top"
    sideOffset={8}
...
export const ModelSelectorInput = ({
  ...
  <CommandInput className={cn("h-auto py-3 text-[14px]", className)} {...props} />
);

export type ModelSelectorListProps = ComponentProps<typeof CommandList>;

export const ModelSelectorList = ({ className, ...props }: ModelSelectorListProps) => (
  <CommandList className={cn("max-h-[340px] p-1.5", className)} {...props} />
);
...
export const ModelSelectorItem = ({ className, ...props }: ModelSelectorItemProps) => (
  <CommandItem className={cn("w-full text-[13.5px] rounded-lg py-2.5 px-2.5 my-0.5", className)} {...props} />
);
